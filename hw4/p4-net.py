#!/usr/bin/env python
"""p4-net.py: See the 4th homework assignment of the course
...
if __name__ == '__main__':
    ...
    # Some small changes here as bird6 command was not available for the bird version 2.0.2
    
    print(f1.cmd("bird -c ./f1-bird.conf -s /var/run/f1-bird.ctl"))
    print(f2.cmd("bird -c ./f2-bird.conf -s /var/run/f2-bird.ctl"))
    print(f3.cmd("bird -c ./f3-bird.conf -s /var/run/f3-bird.ctl"))
    print(f4.cmd("bird -c ./f4-bird.conf -s /var/run/f4-bird.ctl"))

    print(e1.cmd("bird -c ./e1-bird.conf -s /var/run/e1-bird.ctl"))
    print(e2.cmd("bird -c ./e2-bird.conf -s /var/run/e2-bird.ctl"))
    print(e3.cmd("bird -c ./e3-bird.conf -s /var/run/e3-bird.ctl"))
    print(e4.cmd("bird -c ./e4-bird.conf -s /var/run/e4-bird.ctl"))
