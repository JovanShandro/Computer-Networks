...
Imagine the other topology is here
...
if __name__ == '__main__':
    ...
    # Create routers and enable forwarding
    ...
    ''' From h1 to h2 '''
    # h1 to r1 
    h1.cmd('ip -6 route add 2001:638:709:a::/64 via 2001:638:709:a::1/64 dev h1-eth0')
	# r1 to r2 
    r1.cmd('ip -6 route add 2001:638:709:f::/64 via 2001:638:709:f::2/64 dev r1-eth1')
    # r2 to h2 
    r2.cmd('ip -6 route add 2001:638:709:b::/64 via 2001:638:709:b::1/64 dev r2-eth0')

    ''' From h2 to h1 '''
    # h2 to r4 
    h2.cmd('ip -6 route add 2001:638:709:b::/64 via 2001:638:709:b::e/64 dev h2-eth0')
	# r4 to r3 
    r4.cmd('ip -6 route add 2001:638:709:e::/64 via 2001:638:709:e::1/64 dev r4-eth0')
    # r3 to h1 
    r3.cmd('ip -6 route add 2001:638:709:a::/64 via 2001:638:709:a::1/64 dev r3-eth0')
