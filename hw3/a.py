...
if __name__ == '__main__':
	...
	# r1 to h1 
	r1.cmd('ip -6 route add 2001:638:709:a::/64 via 2001:638:709:a::1/64 dev r1-eth0')
	
	# r1 to r2 
	r1.cmd('ip -6 route add 2001:638:709:f::/64 via 2001:638:709:f::2/64 dev r1-eth1')

	# r2 to r1 
	r2.cmd('ip -6 route add 2001:638:709:f::/64 via 2001:638:709:f::1/64 dev r2-eth0')
	
	# r2 to h2 
	r2.cmd('ip -6 route add 2001:638:709:b::/64 via 2001:638:709:b::1/64 dev r2-eth0')

	# h2 to r2 
	h2.cmd('ip -6 route add 2001:638:709:b::/64 via 2001:638:709:f::2/64 dev h2-eth0')
